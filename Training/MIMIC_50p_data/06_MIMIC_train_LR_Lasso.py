...
# # 1. 30_DAYS_EXPIRE processing started
    ...
    Boot_stats.to_csv('Results/MIMIC_30_DAYS_EXPIRE_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 2. AKI processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/MIMIC_AKI_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 3. H_LOS processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/MIMIC_H_LOS_Lasso_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 4. ICU_LOS
    ...
    # saving bootstrap results for each random state and for each outcome    
    Boot_stats.to_csv('Results/MIMIC_ICU_LOS_Lasso_Bootstrap_50p_'+str(random_state)+'.csv')
