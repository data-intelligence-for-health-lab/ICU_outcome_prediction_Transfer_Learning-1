...
for random_state in random_states:
    ...
    _, X_train_df, _, y_train_df = train_test_split(X_train_df_original, y_train_df_original, test_size=0.75, random_state = random_state)    
...
# # 1. 30_DAYS_EXPIRE processing started
    ...
    Boot_stats.to_csv('Results/MIMIC_30_DAYS_EXPIRE_FCNN_Bootstrap_75p_'+str(random_state)+'.csv')
...
# # 2. AKI
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/MIMIC_AKI_FCNN_Bootstrap_75p_'+str(random_state)+'.csv')
...
# # 3. H_LOS processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/MIMIC_H_LOS_FCNN_Bootstrap_75p_'+str(random_state)+'.csv')
...
# # 4. ICU_LOS
    ...
    # saving bootstrap results for each random state and for each outcome    
    Boot_stats.to_csv('Results/MIMIC_ICU_LOS_FCNN_Bootstrap_75p_'+str(random_state)+'.csv')
