...
Boot_stats.to_csv('Results/MIMIC_30_DAYS_EXPIRE_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/MIMIC_AKI_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/MIMIC_H_LOS_Lasso_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome    
Boot_stats.to_csv('Results/MIMIC_ICU_LOS_Lasso_Bootstrap_100p.csv')
