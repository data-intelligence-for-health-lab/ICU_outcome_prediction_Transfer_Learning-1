...
X_train_df = pd.read_pickle('Data/eCrit_master_X_train.pickle', compression = 'zip')
...
y_train_df = pd.read_pickle('Data/eCrit_master_y_train.pickle', compression = 'zip')
...
Boot_stats.to_csv('Results/eCrit_30_DAYS_EXPIRE_FCNN_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_AKI_FCNN_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_H_LOS_FCNN_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome    
Boot_stats.to_csv('Results/eCrit_ICU_LOS_FCNN_Bootstrap_100p.csv')
