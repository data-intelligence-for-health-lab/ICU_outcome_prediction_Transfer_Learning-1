...
Boot_stats.to_csv('Results/eCrit_30_DAYS_EXPIRE_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_AKI_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_H_LOS_Lasso_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome    
Boot_stats.to_csv('Results/eCrit_ICU_LOS_Lasso_Bootstrap_100p.csv')
