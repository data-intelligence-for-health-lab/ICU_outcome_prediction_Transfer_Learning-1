...
Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_30_DAYS_EXPIRE_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_AKI_Bootstrap_100p.csv')    
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_H_LOS_Bootstrap_100p.csv')
...
# saving bootstrap results for each random state and for each outcome
Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_ICU_LOS_Bootstrap_100p.csv')
