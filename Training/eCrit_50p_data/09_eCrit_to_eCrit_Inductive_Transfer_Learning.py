...
# # 1. 30_DAYS_EXPIRE processing started  
    ...
    Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_30_DAYS_EXPIRE_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 2. AKI processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_AKI_Bootstrap_50p_'+str(random_state)+'.csv')    
...
# # 3. H_LOS processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_H_LOS_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 4. ICU_LOS processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_to_eCrit_Inductive_TL_ICU_LOS_Bootstrap_50p_'+str(random_state)+'.csv')
