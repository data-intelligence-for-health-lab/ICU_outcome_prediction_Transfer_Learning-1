...
# hyper parameter values from the corresponding transfer learning model - eCrit_30_DAYS_EXPIRE_R20_SM_929.h5
...
# # 1. 30_DAYS_EXPIRE processing started
    ...
    # Extracting validation and test dataset 
    ...
    Boot_stats.to_csv('Results/eCrit_30_DAYS_EXPIRE_FCNN_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 2. AKI
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_AKI_FCNN_Bootstrap_50p_'+str(random_state)+'.csv')
    
    
    
# # 5. H_LOS processing started
    
    # Extracting train, validation and test dataset
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_H_LOS_FCNN_Bootstrap_50p_'+str(random_state)+'.csv')
...
# # 6. ICU_LOS
    ...
    # saving bootstrap results for each random state and for each outcome    
    Boot_stats.to_csv('Results/eCrit_ICU_LOS_FCNN_Bootstrap_50p_'+str(random_state)+'.csv')
