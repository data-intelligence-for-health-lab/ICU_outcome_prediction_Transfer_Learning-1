...
# # 1. 30_DAYS_EXPIRE processing started
    ...
    Boot_stats.to_csv('Results/eCrit_30_DAYS_EXPIRE_Bootstrap_75p_'+str(random_state)+'.csv')
...
# # 2. AKI processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_AKI_Bootstrap_75p_'+str(random_state)+'.csv')
...
# # 3. H_LOS processing started
    ...
    # saving bootstrap results for each random state and for each outcome
    Boot_stats.to_csv('Results/eCrit_H_LOS_Lasso_Bootstrap_75p_'+str(random_state)+'.csv')
...
# # 4. ICU_LOS
    ...
    # saving bootstrap results for each random state and for each outcome    
    Boot_stats.to_csv('Results/eCrit_ICU_LOS_Lasso_Bootstrap_75p_'+str(random_state)+'.csv')
